...
public record CloudEventDTO(
    ...
    @Schema(description = "Event source URI", example = "/vertreter-service")
    @NotBlank(message = "Source is required")
    String source,

    @Schema(description = "CloudEvents specification version", defaultValue = "1.0")
    String specversion,

    @Schema(description = "Event type", example = "de.vertreter.updated")
    @NotBlank(message = "Event type is required")
    String type,

    @Schema(description = "Subject/aggregate ID", example = "v001")
    String subject,

    @Schema(description = "Event timestamp")
    OffsetDateTime time,

    @Schema(description = "Content type of data", defaultValue = "application/json")
    String datacontenttype,

    @Schema(description = "Data schema URI")
    String dataschema,

    @Schema(description = "Event payload", example = "{\"id\": \"v001\", \"name\": \"Max Mustermann\", \"email\": \"max@example.com\"}")
